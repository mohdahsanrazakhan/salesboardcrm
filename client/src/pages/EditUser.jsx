...
const EditUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Error updating user!", { // ✅ Fixed Error Toast
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  return (
    <div className="bg-white m-auto rounded-lg border border-gray-200">
      <h2 className="text-xl mb-3 border-b border-gray-200 p-3 pl-5 poppins-medium text-slate-700">Edit a User</h2>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-5">
        ...
        <div className="flex justify-between items-center">
          <button type="submit" className="group relative inline-flex items-center overflow-hidden rounded-sm bg-[#8b5cf6] px-8 py-3 text-white focus:ring-3 focus:outline-hidden w-fit mr-5">
          ...
          <button type="submit" className="group relative inline-flex items-center overflow-hidden rounded-sm bg-red-600 px-8 py-3 text-white focus:ring-3 focus:outline-hidden w-fit">
            <span className="absolute -end-full transition-all group-hover:end-4">
              <svg
                className="size-5 rtl:rotate-180"
                xmlns="http://www.w3.org/2000/svg"
